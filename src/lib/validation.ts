...
export const checklistSchema = z.object({
	...
	coverLetterId: z.string().optional(), // ✅ Optional, if exists must be a string
	investigatorCV: z.boolean().optional(),
	investigatorCVId: z.string().optional(),
	gcpTraining: z.boolean().optional(),
	gcpTrainingId: z.string().optional(),
	ecClearance: z.boolean().optional(),
	ecClearanceId: z.string().optional(),
	mouCollaborators: z.boolean().optional(),
	mouCollaboratorsId: z.string().optional(),
	protocolCopy: z.boolean().optional(),
	protocolCopyId: z.string().optional(),
	participantPISICF: z.boolean().optional(),
	participantPISICFId: z.string().optional(),
	assentForm: z.boolean().optional(),
	assentFormId: z.string().optional(),
	waiverConsent: z.boolean().optional(),
	waiverConsentId: z.string().optional(),
	proformaCRF: z.boolean().optional(),
	proformaCRFId: z.string().optional(),
